...
def get_atoms(request, subjID):
    ...
    for category in Categories:
        ...
        for student in Students:
            ...
            students_list.append({"name": student.user.first_name + ' ' + student.user.last_name, "atoms":  atoms})
        categories_list.append({"name": category.cat_name, "students": students_list})
    return({"categories": categories_list, "group_name": group.group_name})
